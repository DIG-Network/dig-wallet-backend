...
//! or reconnects, it calls [`CatchUp::catch_up`](crate::types::CatchUp::catch_up) ONCE with its
//! last [`Cursor`](crate::types::Cursor) to backfill the missed range from the engine's
//! persisted delta, then resumes the live stream.
//!
//! [`CatchUp`](crate::types::CatchUp) and [`filter_events`](crate::types::filter_events) are the
//! canonical `dig-events-protocol` shape trait + filtering rule (re-exported via
...
mod tests {
    use super::*;
    use crate::types::{filter_events, Cursor, WalletEvent, WalletId};
